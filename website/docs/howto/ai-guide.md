...
We ask every contributor who chooses to use AI to follow three principles.
...
CODA issues are created for people to learn from. If you cannot complete an issue without an AI tool doing the most of the work, do not try to force it with AI. You are unlikely to learn much from the process, and you may not be able to properly verify the result. Instead, ask your mentor for support, or choose a different issue.

### Responsibility

You must understand and stand behind what you submit. AI can help you produce better work, but the work must remain yours to own. Even if you used AI tools, you must ensure that your contribution still reflects your judgement, skills, and competence.

## What we do not accept

AI usage in CODA should be done responsibly, as a tool that supports your work and growth, not as a replacement for thinking, crafting, and tinkering. There are ways of using AI that undermine the purpose of CODA. Some examples that would be rejected by the mentor include:

- Submitting AI-generated content as your own work.
- Running documents through an LLM to substitute synonyms or reword sentences without adding clarity.

If you are unsure whether a particular use of AI is appropriate, raise your questions in our Matrix channel or ask the mentor directly in the issue. If you need a quick response, the [Matrix channel](https://matrix.to/#/#documentation:ubuntu.com) is a great option to notify us.